                ...
                formatter: function (value, row, index) {//这里的三个参数：value表示当前行当前列的值；row表示当前行的数据；index表示当前行的索引（从0开始）。
                    ...
                    if(row.taskType=="00"){
                        ...
                        html = '<div style=\'width:100%;\'>' +
                            ...
                            '<button type="button" onclick="delayModel(' + row.id + ')" class="btn btn-primary"  style="font-weight:150;font-size:12px;padding:3px 8px;margin: 5px"><span class="glyphicon glyphicon-remove" aria- hidden="true" ></span >申请延期</button >' +
                            '<button type="button" onclick="examineAj(' + row.id + ','+0 + ')" class="btn-danger"  style="font-weight:150;font-size:12px;padding:3px 8px;margin: 5px"><span class="glyphicon glyphicon-pencil" aria- hidden="true" ></span >申请延期通过</button >&nbsp;&nbsp;' +
            ...
            if (data != null ) {
                for (var k = 0; k < data.length; k++) {
                    if (data[k].taskType == '00') {
                        var productTypeObj = $('#tb_backlog tr[data-index=' + k + '] a[data-name="taskInfo"]').parent();
...
function getTaskSubName(value) {
    ...
    switch (value) {
        ...
        case "101":
            ...
            break;
        case "102":
            taskSubName = "2、商机发现10%";
            break;
        case "103":
            taskSubName = "3、商机确立25%";
            break;
        case "104":
            taskSubName = "4、商机确立50%";
            break;
        case "105":
            taskSubName = "5、商机确认75%";
            break;
        case "106":
            taskSubName = "6、商机赢取100%";
            break;
        case "107":
            taskSubName = "7、客户维护/回款阶段";
            break;
        case "108":
            taskSubName = "商机关闭";
            break;
        case "201":
            taskSubName = "1、初步意向方案";
            break;
        case "202":
            taskSubName = "2、写立项方案";
            break;
        ...
        case "403":
            ...
            break;
        case "404":
            taskSubName = "4、开发进度10%";
            break;
        case "405":
            taskSubName = "5、开发进度25%";
            break;
        case "406":
            taskSubName = "6、开发进度50%";
            break;
        case "407":
            taskSubName = "7、开发进度75%";
            break;
        case "408":
            taskSubName = "8、开发进度100%";
            break;
        case "409":
            taskSubName = "9、内部测试优化";
            break;
        case "410":
            taskSubName = "10、客户测试优化";
            break;
        case "411":
            taskSubName = "11、实施交付";
            break;
